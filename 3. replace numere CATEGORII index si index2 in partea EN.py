# -*- coding: utf-8 -*-
"""
Script care inlocuieste sectiunea Categories din index.html si index2.html (Sedinta 18 ENGLEZA)
cu sectiunea corespunzatoare din Principal 2022/en/index.html
...
# Căi absolute - versiunea EN
SOURCE_FILE = r"e:\Carte\BB\17 - Site Leadership\Principal 2022\en\index.html"
TARGET_FILES = [
    r"e:\Carte\BB\17 - Site Leadership\alte\Ionel Balauta\Aryeht\Task 1 - Traduce tot site-ul\Doar Google Web\Andreea\Meditatii\Sedinta 18\ENGLEZA\index.html",
    r"e:\Carte\BB\17 - Site Leadership\alte\Ionel Balauta\Aryeht\Task 1 - Traduce tot site-ul\Doar Google Web\Andreea\Meditatii\Sedinta 18\ENGLEZA\index2.html",
]
...
def main():
    print("=" * 60)
    print("Replace Categories sectiune din Principal 2022 EN in Sedinta 18 ENGLEZA")
    print("=" * 60)
