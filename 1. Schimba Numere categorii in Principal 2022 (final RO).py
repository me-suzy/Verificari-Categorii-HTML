...
title_to_file = {
    'Lideri &#351;i Atitudine': 'lideri-si-atitudine.html',
    'Leadership Magic': 'leadership-magic.html',
    'Leadership de Succes': 'leadership-de-succes.html',
    'HR - Resurse Umane': 'hr-resurse-umane.html',
    'Legile Conducerii': 'legile-conducerii.html',
    'Leadership Total': 'leadership-total.html',
    'Leadership de Durat&#259;': 'leadership-de-durata.html',
    'Principiile Conducerii': 'principiile-conducerii.html',
    'Leadership Plus': 'leadership-plus.html',
    'Calit&#259;&#355;ile unui Lider': 'calitatile-unui-lider.html',
    'Leadership de V&#226;rf': 'leadership-de-varf.html',
    'Leadership Impact': 'leadership-impact.html',
    'Dezvoltare Personal&#259;': 'dezvoltare-personala.html',
    'Aptitudini &#351;i Abilit&#259;&#355;i': 'aptitudini-si-abilitati-de-leadership.html',
    'Leadership Real': 'leadership-real.html',
    'Leadership de Baz&#259;': 'leadership-de-baza.html',
    ...
    'Jurnal de Leadership': 'jurnal-de-leadership.html',
...
for folder_path in [base_path, python_path]:
    ...
    for index, html_file in enumerate(all_files, 1):
        ...
        # Corectare link-uri (înlocuiește .ro cu .com)
        for title, correct_file in title_to_file.items():
            # Pattern care acceptă atât .com cât și .ro
            pattern = r'href="https://neculaifantanaru\.(?:com|ro)/[^"]+" title="' + re.escape(title) + r'"'
            correct_href = f'href="https://neculaifantanaru.com/{correct_file}" title="{title}"'
        ...
        for category_file, count in category_counts.items():
            ...
            broken_pattern = (
                r'(<a\s+href="https://neculaifantanaru\.(?:com|ro)/'
...
for folder_path in [base_path, python_path]:
    ...
    for html_file in html_files:
        ...
        for category_file, expected_count in category_counts.items():
            ...
            pattern = r'<a\s+href="https://neculaifantanaru\.(?:com|ro)/' + re.escape(category_file) + r'"[^>]*>.*?<span>(\d+)</span>'
